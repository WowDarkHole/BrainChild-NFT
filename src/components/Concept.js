    ...
    <div className="min-h-screen items-center flex w-full justify-center mt-screen-1/4" ref={ref.containerRef}>
      <div className="flex w-full px-8 md:px-32 pb-16 pt-32 md:pt-36 sm:pb-20" style={{height: 'max-content'}} ref={ref.contentRef}>
        <Accordion className="w-full">
          <div className="block sm:flex sm:w-full disable-animation">
            <div className={"sm:w-84 z-10 "+(window.innerWidth < 640 && slide === 1 ? "sticky top-24" : "")}>
            ...
            <div className="w-full sm:ml-8 mt-2 sm:mt-0">
              ...
              <div className="p-10 sm:p-16 background-blur">
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-10 items-center justify-items-center mt-10">
                  <div className="col-span-1 sm:col-span-3">
                    <p className="font-cormorant text-3xl sm:text-4xl font-semibold italic leading-snug" style={{textIndent: '5rem'}}>
                ...
                <div>
                  <p className="font-cormorant text-3xl sm:text-4xl font-semibold italic leading-snug">Random traits in tokens determining rarity</p>
