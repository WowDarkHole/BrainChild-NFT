...
const Roadmap = forwardRef((_, ref) => {
  ...
  return (
    <div className="app-main" style={{backgroundImage: 'url(/assets/resource_landing_image4.svg)'}} >
      <div className="relative h-screen flex items-center overflow-x-scroll overflow-y-hidden no-scrollbar" ref={dragRef} onMouseDown={onMouseDown} style={{cursor: 'url(/assets/image_cursor_drag.svg), auto'}}>
        <div className="flex py-24 m-auto" ref={ref}>
