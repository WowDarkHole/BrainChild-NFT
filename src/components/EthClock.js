...
const EthClock = forwardRef((_, ref) => {
  ...
  return (
    <div className="relative min-h-screen flex items-center overflow-x-scroll overflow-y-hidden no-scrollbar mt-screen-1/4 select-none" ref={ref.containerRef}>
      <div className="p-4 sm:p-24 w-full container mx-auto" ref={ref.contentRef}>
        ...
        <p className="background-blur p-10 sm:p-24 mt-10 leading-normal sm:leading-normal font-cormorant font-semibold text-2xl sm:text-4xl italic">
        ...
        <div className="background-blur p-10 sm:p-24 mt-10">
          ...
          <p className="font-cormorant font-semibold leading-normal sm:leading-normal text-2xl sm:text-4xl italic mt-10">
