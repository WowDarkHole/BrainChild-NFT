    ...
    <div className="relative min-h-screen flex items-center overflow-x-scroll overflow-y-hidden no-scrollbar mt-screen-1/4 select-none" ref={ref.containerRef}>
      <div className="p-4 sm:p-24 w-full" ref={ref.contentRef}>
        <div className="relative w-60 sm:w-160 m-auto">
          ...
          <h1 className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-20 h-20 sm:w-36 sm:h-36">
            <div className="relative rounded-full" style={{clipPath: 'circle(49%)'}}>
        ...
        <p className="background-blur p-10 sm:p-24 mt-10 font-cormorant font-bold text-2xl sm:text-4xl italic">
        ...
        <div className="background-blur p-10 sm:p-24 mt-10">
          <h2 className="font-sora font-extrabold text-2xl sm:text-4xl">
            HOW TO GET IT?
          </h2>
          <p className="font-cormorant font-bold text-2xl sm:text-4xl italic mt-10">
          ...
          <a className="block font-sora font-semibold underline text-xl mt-10" href="/">
            Learn More
          </a>
        </div>
      </div>
