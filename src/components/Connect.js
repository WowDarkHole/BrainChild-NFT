          ...
          <div className="absolute top-0 w-full" ref={ref.contentRef}>
            ...
            <div className={"relative flex flex-col justify-center items-center h-1/2 min-h-screen-2/5 w-full pb-20 pt-8 "+(isMobileDevice() ? "px-5" : "sm:pb-40 sm:pt-20 px-10 sm:px-20 lg:px-30")} style={{backgroundColor: '#22262A'}}>
              ...
              <div className="flex justify-between w-full mt-10 md:mt-0 px-8 min-w-48">
                <embed className={"w-8 "+(isMobileDevice() ? "": "sm:w-12 xl:w-16")} src="/assets/image_connect_instagram.svg"/>
                <embed className={"w-8 "+(isMobileDevice() ? "": "sm:w-12 xl:w-16")} src="/assets/image_connect_twitter.svg"/>
                <embed className="w-3/5 hidden landscape:block" src="/assets/text_connect_hop.svg"/>
                <embed className={"w-8 "+(isMobileDevice() ? "": "sm:w-12 xl:w-16")} src="/assets/image_connect_discord.svg"/>
                <embed className={"w-8 "+(isMobileDevice() ? "": "sm:w-12 xl:w-16")} src="/assets/image_connect_telegram.svg"/>
              </div>
            </div>
          </div>
        </div>
